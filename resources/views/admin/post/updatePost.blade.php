      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ url('admin/save-update-post') }}" method="post">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="Keywords" name="keywords" class="form-control" placeholder="Javascript, php" value="{{ $post->keywords }}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" placeholder="A few words about your post ...">{{ $post->description }}</textarea>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Image URL</label>
                        <input type="url" id="url" name="url" class="form-control" placeholder="Image URL" value="{{ $post->image }}">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" id="post-url" name="posturl" class="form-control" placeholder="Post URL" value="{{ $post->url }}">
                  </div>
                  <div class="form-group">
                    <label class="form-control-label">About Me</label>
                    <textarea id="newpost" name="content" class="form-control" placeholder="A few words about you ...">{{ $post->content }}</textarea>
                  </div>
                </div>
                <div class="col-4">
